...
function esDiezOCinco(numero) {
  ...
  if (numero === 10 || numero === 5) { return numero;}
...
function estaEnRango(numero) {
  ...
  // De lo contrario, devuelve "false"
  // Tu código:
if (numero < 50 && numero > 20) { return numero;}
...
function doWhile(numero) {
  ...
  let i=0
do {var resultado = numero + i } while (i<5); return resultado;
